        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                <div class="side-nav-wrapper">
                    <div class="sidebar-profile">
                        ...
                        <% } else {%>
                        	<a class="waves-effect waves-light btn blue m-b-xs" href="dangnhap" style="color: white !important; padding: 4%; !important">
                                Đăng nhập
                            </a>
                            <a href="dangky" class="waves-effect waves-light btn green m-b-xs" style="color: white !important; padding: 4% !important;">
                                Đăng ký
                            </a>
                        <%} %>
            ...
            <main class="mn-inner inner-active-sidebar">
               <jsp:include page="sanpham.jsp">
                	<jsp:param name="danhsachsanpham" value="${danhsachsanpham}"/>
               </jsp:include>          
            <%--       <jsp:include page="ChiTietSanPham.jsp"></jsp:include> --%>
            </main>
