                              ...
                              <div class="card white darken-1">
                                  <div class="card-content ">
                                      <span class="card-title">Đăng ký</span>
                                       <div class="row">
                                           <form class="col s12" method="post" action="dangky">
                                               ...
                                               <div class="input-field col s12">
                                                   <input id="matkhau1" name="matkhau1" type="password" class="validate">
                                               ...
                                               %>
                                               <div>                                                   
                                                   <label style="margin-left: 3%;color: red;font-size: 1em;"><%= ketQua %></label>
                                               </div>
                                               <%} %>
                                               
                                               <div class="col s12 right-align m-t-sm">
                                                   <a href="dangnhap" class="waves-effect waves-grey btn-flat">Đăng Nhập</a>
                                                   <input type="submit" class="waves-effect waves-light btn teal" value="Đăng ký"></input>
                                               </div>
                                           </form>
                                      </div>
                                  </div>
