<%@page import="com.tano.entity.SanPham"%>
...
<html lang="en">
    <head>        
        ...
        <link href='<c:url value = "/resources/assets/plugins/metrojs/MetroJs.min.css"/>' rel="stylesheet">
        <link href='<c:url value = "/resources/assets/plugins/weather-icons-master/css/weather-icons.min.css"/>' rel="stylesheet">
    ...
    <body>
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3 m3">      
                            <span class="chapter-title">Tano Shop</span>
                        </div>
                        ...
                        <div class="col s12 m4 search-result-container">
                            <div class="card card-transparent">
                                <div class="row valign-wrapper">
                                    <div class="col s3">
                                        <img src='<c:url value = "/resources/assets/images/profile-image-1.png"/>' alt="" class="circle responsive-img z-depth-1">
                                    </div>
                                    <div class="col s9">
                            ...
                            <div class="card card-transparent">
                                <div class="row valign-wrapper">
                                    <div class="col s3">
                                        <img src='<c:url value = "/resources/assets/images/profile-image-3.jpg"/>' alt="" class="circle responsive-img z-depth-1">
                                    </div>
                                    <div class="col s9">
                                        <span class="search-result-text">
                            ...
                            <div class="card card-transparent">
                                <div class="row valign-wrapper">
                                    <div class="col s3">
                                        <img src='<c:url value = "/resources/assets/images/profile-image.png"/>' alt="" class="circle responsive-img z-depth-1">
                                    </div>
                                    <div class="col s9">
                                        <span class="search-result-text">
                    ...
                    <div id="sidebar-chat-tab" class="col s12 sidebar-messages right-sidebar-panel">
                        ...
                        <div class="chat-list">
                            <a href="javascript:void(0)" class="chat-message">
                                <div class="chat-item">
                                    <div class="chat-item-image">
                                        <img src='<c:url value = "/resources/assets/images/profile-image.png"/>' class="circle" alt="">
                                    </div>
                            ...
                            <a href="javascript:void(0)" class="chat-message">
                                <div class="chat-item">
                                    <div class="chat-item-image">
                                        <img src='<c:url value = "/resources/assets/images/profile-image-1.png"/>' class="circle" alt="">
                                    </div>
                                    <div class="chat-item-info">
                            ...
                            <a href="javascript:void(0)" class="chat-message">
                                <div class="chat-item">
                                    <div class="chat-item-image">
                                        <img src='<c:url value = "/resources/assets/images/profile-image-3.jpg"/>' class="circle" alt="">
                                    </div>
                                    <div class="chat-item-info">
            ...
            <aside id="chat-messages" class="side-nav white">
                ...
                <div class="messages-container">
                    <div class="message-wrapper them">
                        <div class="circle-wrapper"><img src='<c:url value = "/resources/assets/images/profile-image-1.png"/>' class="circle" alt=""></div>
                        <div class="text-wrapper">Lorem Ipsum</div>
                    </div>
                    <div class="message-wrapper me">
                        <div class="circle-wrapper"><img src='<c:url value = "/resources/assets/images/profile-image-3.jpg"/>' class="circle" alt=""></div>
            ...
            <aside id="slide-out" class="side-nav white fixed">
                <div class="side-nav-wrapper">
                    <div class="sidebar-profile">
                        <div class="sidebar-profile-image" style="text-align:center">
                            <img src='<c:url value = "/resources/assets/images/profile-image.png"/>' class="circle" alt="">
                        </div>
                        ...
                        <% } else {%>
                        	<a class="waves-effect waves-light btn blue m-b-xs" href="dangnhap">
                                Đăng nhập
                            </a>
                            <a href="dangky" class="waves-effect waves-light btn green m-b-xs">
                                Đăng ký
                            </a>
                        <%} %>
                    ...
                    <div class="sidebar-account-settings">
                        <ul>
                            <li class="no-padding">
                                <a href="dangnhap" class="waves-effect waves-grey"><i class="material-icons">mail_outline</i>Tài khoản</a>
                            </li>
                            <li class="no-padding">
                            ...
                            <li class="divider"></li>
                            <li class="no-padding">
                                <a class="waves-effect waves-grey" href="dangnhap/dangxuat"><i class="material-icons">exit_to_app</i>Đăng xuất</a>
                            </li>
                        </ul>
                    </div>
            ...
            <main class="mn-inner inner-active-sidebar">
              	<div class="row">
					<div class="col s12 m12 l12">
						<div class="card">
							<div class="card-content">
								<h4 style="color:#2196F3 !important"><%= sanpham.getTensanpham() %></h4> 
             *					Test ten san pham: <c:out value="${sanpham.getTensanpham()}"/>
							</div>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-content">
								<div class="card-content">
									...
									<div class="slider">
										<ul class="slides">
											<li><img src='<c:url value = "/resources/Image/HinhSanPham/${sanpham.getHinhsanpham()}"/>' alt="">
											</li>
											<li><img src='<c:url value = "/resources/Image/HinhSanPham/${sanpham.getHinhsanpham1()}"/>' alt="">
											</li>
											<li><img src='<c:url value = "/resources/Image/HinhSanPham/${sanpham.getHinhsanpham2()}"/>' alt="">
											</li>							
										</ul>
									</div>
								</div>
					...
					<div class="col s12 m12 l7">
						<div class="card">
							<div class="card-content">
								<h3 style="color:red;"><span class="card-title"><b><%=sanpham.getGiatien() %>đ</b></span></h3>
								<p>
									These classes are for horizontally aligning content. We have
									<code>.left-align</code>
									,
									<code>.right-align</code>
									and
									<code>.center-align</code>
								</p>
								<br>
								...
								<div class="talign-demo">
									<div class="row">
										<a class="col s12 waves-effect waves-light btn"><i class="material-icons left">cloud</i>Mua ngay</a>
									</div>
									<div class="row">
										<a class="col s6 waves-effect waves-light btn"><i class="material-icons left">cloud</i>Trả góp 0%</a>
										<a class="col s6 waves-effect waves-light btn"><i class="material-icons left">cloud</i>Trả góp qua thẻ</a>
									</div>
					...
					<div class="col s12 m12 l12">
						<div class="card">
							<div class="card-content">
								<span class="card-title">Chi tiết sản phẩm</span>
							</div>
						</div>
					</div>
					<div class="col s12 m12 l12">
						<div class="card">
							<div class="card-content">
								<span class="card-title">Bình luận sản phẩm</span> 
							</div>
						</div>
					</div>
					...
					<div class="col s12 m12 l12">
						<div class="card">
							<div class="card-content">
								<span class="card-title">Sản phẩm liên quan</span>
								<br>
        ...
        <script src='<c:url value = "/resources/assets/plugins/waypoints/jquery.waypoints.min.js"/>'></script>
        <script src='<c:url value = "/resources/assets/plugins/counter-up-master/jquery.counterup.min.js"/>'></script>
        <script src='<c:url value = "/resources/assets/plugins/jquery-sparkline/jquery.sparkline.min.js"/>'></script>
        <script src='<c:url value = "/resources/assets/plugins/chart.js/chart.min.js"/>'></script>
        ...
        <script src='<c:url value = "/resources/assets/plugins/flot/jquery.flot.symbol.min.js"/>'></script>
        ...
        <script src='<c:url value = "/resources/assets/plugins/curvedlines/curvedLines.js"/>'></script>
        <script src='<c:url value = "/resources/assets/plugins/peity/jquery.peity.min.js"/>'></script>
        <script src='<c:url value = "/resources/assets/js/alpha.min.js"/>'></script>
        
        
        <script	src='<c:url value = "/resources/assets/plugins/material-preloader/js/materialPreloader.min.js"/>'></script>
        <script src='<c:url value = "/resources/assets/plugins/google-code-prettify/prettify.js"/>'></script>
	<script src='<c:url value = "/resources/assets/js/pages/media.js"/>'></script>
    </body>
</html>